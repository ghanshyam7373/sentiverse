            ...
            <div className='guidepart'>
                <div className="guideDiv">
                    ...
                    <h4>Positive Sentiment</h4>
                        ...
                        <h4>Neutral Sentiment</h4>
                            <p>Neutral sentiment: Neither good nor bad, neutral posts aren't helping your reputation, but they aren't hurting it either. People are using words like “okay” or “adequate” to describe you.</p>
                        <h4>Negative Sentiment</h4>
                            <p>A fact, situation, or experience that is negative is unpleasant, depressing, or harmful.</p>
                </div>
                <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                    <div className="col-md-4 d-flex align-items-center">
                        ...
                        <span className="mb-3 mb-md-0 text-muted">&copy; 2022 Sentiverse</span>
                    </div>

                    <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
                        <li className="ms-3"><a className="text-muted" href="https://github.com/ghanshyam7373" target="_blank" rel="noreferrer">
                        ...
                        <li className="ms-3"><a className="text-muted" href="https://www.linkedin.com/in/mistryghanshyam/" target="_blank" rel="noreferrer">
